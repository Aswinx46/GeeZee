                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="md:w-2/3 space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${banner.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                          }`}>
                          {banner.status.charAt(0).toUpperCase() + banner.status.slice(1)}
                        </span>
                      </div>
                      <div>
                          <p className="text-gray-600">showpage name</p>
                          <p className="font-medium">{banner.showPageName}</p>
                        </div>
                    </div>
                  </div>
                </motion.div>
          ...
          <div className="space-y-6 mb-8">
            ...
            <div>
              ...
              <input
                ...
                id="name"
                name="showPageName"
                value={formData.showPageName}
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 
                  ${errors.showPageName ? 'border-red-500' : 'border-gray-300'}`}
                placeholder="Enter banner name"
              />
              {errors.showPageName && (
                <p className="mt-1 text-sm text-red-500">{errors.showPageName}</p>
              )}
            </div>
