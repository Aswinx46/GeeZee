...
//   const renderTopTenList = (items, icon, title) => (
//     <motion.div
...
//           animate="visible"
//         >
//           {renderTopTenList(topProducts, <TrendingUp className="w-6 h-6 text-blue-500" />, "Top 10 Products")}
//           {renderTopTenList(topBrands, <Award className="w-6 h-6 text-yellow-500" />, "Top 10 Brands")}
//           {renderTopTenList(topCategories, <BarChart3 className="w-6 h-6 text-green-500" />, "Top 10 Categories")}
//         </motion.div>
//       </div>
//     </section>
//   );
