  ...
  return (
    <div className="bg-black">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="max-w-7xl mx-auto px-4 py-8 bg-[#000000]"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <motion.div
              layoutId="main-image"
              className="bg-[#1b1b1b] rounded-lg p-4 border border-[#3d3d3d]"
            >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1">
                  <span className="text-2xl font-bold text-[#8b5cf6]">{product.price}</span>
                  <span className="text-xl text-gray-500 line-through">50000.</span>
                </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full py-3 bg-[#8b5cf6] text-white rounded-md font-medium hover:bg-[#7c3aed] transition-colors"
              >
                Add to Cart
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full py-3 bg-[#8b5cf6] text-white rounded-md font-medium mt-2 hover:bg-[#7c3aed] transition-colors"
              >
                Buy Now
              </motion.button>
              {/* Detailed Description */}
              <div>
              <span className='text-2xl text-[#8b5cf6] font-bold my-6' > In stock : {product.availableQuantity}</span>
              </div>
              <div className="prose prose-sm max-w-none mt-6">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-full py-3 bg-[#8b5cf6] text-white rounded-md font-medium mt-4 hover:bg-[#7c3aed] transition-colors"
        ...
        <div className="mt-16 mb-8">
          ...
          <div className="space-y-6">
            {/* Review 1 */}
            <div className="bg-[#1b1b1b] p-6 rounded-lg shadow-sm border border-[#3d3d3d]">
              ...
              <p className="text-gray-300">Great product! The quality is excellent and it arrived earlier than expected. Would definitely recommend to others.</p>
            </div>
            {/* Review 2 */}
            <div className="bg-[#1b1b1b] p-6 rounded-lg shadow-sm border border-[#3d3d3d]">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h3 className="font-semibold text-white">Sarah Smith</h3>
                  <div className="flex items-center">
                    {[1, 2, 3, 4].map((star) => (
                      <svg key={star} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              ...
              <p className="text-gray-300">Very satisfied with my purchase. The product meets all my expectations and the customer service was excellent.</p>
            </div>
            {/* Review 3 */}
            <div className="bg-[#1b1b1b] p-6 rounded-lg shadow-sm border border-[#3d3d3d]">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">Absolutely love it! The quality is top-notch and it's exactly what I was looking for. Fast shipping too!</p>
            </div>
          </div>
        </div>
        {/* Related Products */}
        <div className="mt-16">
          <h2 className="text-xl font-bold mb-6 text-white">Related Products</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((item) => (
              <motion.div
                key={item}
                whileHover={{ y: -5 }}
                className="bg-[#1b1b1b] rounded-lg shadow-sm overflow-hidden border border-[#3d3d3d]"
              >
                ...
                <div className="p-4">
                  <h3 className="text-sm font-medium text-white">Related Product {item}</h3>
          ...
          {isReviewModalOpen && (
            ...
            >
              <motion.div
                ...
                className="bg-[#1b1b1b] rounded-lg p-6 w-full max-w-md border border-[#3d3d3d]"
              >
                <h2 className="text-2xl font-bold mb-4 text-white">Write a Review</h2>
                <textarea
                  className="w-full h-32 p-2 bg-[#2d2d2d] text-white border border-[#3d3d3d] rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-[#8b5cf6]"
