        ...
        <div className="lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)] lg:overflow-auto space-y-6 pb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="prose prose-sm max-w-none mt-6">
              ...
              {/* <div className="mt-4">
                <p className="text-gray-700 font-medium">【Professional Gaming Features】</p>
                <p className="text-gray-600">
                  The incredible response time means that even when the action heats up, your gameplay will be smooth 
                  and lag-free, 0.5MS Response time for blur-free gaming. Enabling smooth gameplay, eliminating input lag 
                  and providing instant response.
                </p>
              </div> */}
            </div>
